# -*- coding: utf-8 -*-
"""
Created on Thu Aug 20 01:16:42 2015
...
import os
os.chdir('C://Users//rakeshreddy//Desktop//Topic modeling//output')
...
def perform_LDA(csv_file):
    ...
    lda = models.LdaModel(corpus, num_topics=num_topics, id2word=dictionary, passes = 10000)
    all_issues = []
    top_words = []
    num_top_words = 5
    ...
    for topic_num in range(num_topics):
        ...
        best_doc_id = top[0][0]
        issue_of_the_topic = headings[best_doc_id]
